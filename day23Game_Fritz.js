...
/* Puzzle diagram
Move letters to order AA, BB, CC, DD
No more than one stop in the corridor spaces before home
No stops in corridor above doors
Cost of each spaced moved:
A - 1
B - 10
C - 100
D - 1000 
...
// I solved this manually by considering the minimum possible cost for each move from start to end
//  position and adding the minimum required to effect it
// An interesting puzzle and solved with innovative code below ..

// The following solution code is by Fritz179 on Github
const fs = require('fs')
